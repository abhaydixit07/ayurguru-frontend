            ...
            <div className="hidden md:flex space-x-4">
              {isLogged ? (
                <>
                  <Link
                    to="/consult"
                    className="inline-flex items-center px-4 py-2 text-sm font-spacegroteskmedium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-white"
                  >
                    Consult
                  </Link>
                  <button
          ...
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
              <li>
                <a
                  href="#"
                  className="block text-xl py-2 px-3 font-spacegroteskregular text-white bg-blue-700 rounded md:bg-transparent md:text-emerald-400 md:p-0"
                  aria-current="page"
                >
                  Home
                </a>
              ...
              <li>
                <a
                  href="/about"
                  className="block text-xl py-2 px-3 text-gray-900 font-spacegroteskregular rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-emerald-400 md:p-0"
                >
                  About
                </a>
              </li>
                ...
                {isLogged ? (
                  <>
                    <li>
                      <Link
                        to="/consult"
                        className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-emerald-400 md:p-0"
                      >
                        Consult
                      </Link>
                    </li>
                    <li>
                      <button
                        onClick={handleLogout}
                        className="block w-full text-left py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-emerald-400 md:p-0"
                      >
                        Logout
                      </button>
                    </li>
