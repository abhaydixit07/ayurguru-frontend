...
//   const [count, setCount] = useState(0)
  ...
  return (
    ...
    <div className='rounded-xl bg-gradient-to-r from-[#93FE51] to-[#A1E396] md:grid grid-cols-2 m-10 text-center'>
        ...
        <div className='grid md:grid-cols-3 sm:m-20 gap-5 my-20'>
            ...
            <div className="flex justify-center card border-4 border-black shadow-[0px_4px_16px_px_#367E08] h-[400px] w-[280px] group gap-[0.5em] rounded-[1.5em] relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden">
                ...
                <div className="h-fit w-full">
                    ...
                    className="card_heading text-lg tracking-[.2em]"
                    >
            ...
            <div className='flex justify-center'><div className="flex justify-center card border-4 border-black shadow-[0px_4px_16px_px_#367E08] h-[400px] w-[280px] group gap-[0.5em] rounded-[1.5em] relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden">
                <div className="absolute top-0 left-0 h-full w-full bg-[#A1E396]" />
                <div className="container text-black z-[2] relative font-nunito flex flex-col gap-[0.5em]">
                <div className="h-fit w-full">
                    <img src={divpic1}/>
                    <h1
