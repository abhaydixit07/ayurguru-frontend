      ...
      <div className="grid md:grid-cols-2 sm:mx-20 mx-10 justify-between">
        <div className="sm:mx-10">
          ...
          <div className="mt-10 font-serif text-lg">
            "Discover Balance, Wellness, and Harmony with Ayurveda: Your Journey
            to Holistic Health Begins Here."
          </div>
        </div>
      ...
      <div className="sm:rounded-xl bg-gradient-to-r from-[#93FE51] to-[#A1E396] md:grid grid-cols-2 sm:m-10 my-10 p-10 sm:p-1 text-center">
        <div className="sm:m-20">
          ...
          <div className="sm:text-xl">
            ...
            resources. Whether you're a seasoned Ayurvedic practitioner or just
            beginning your wellness journey, our curated materials provide
            valuable insights, tips, and guidance.
          </div>
